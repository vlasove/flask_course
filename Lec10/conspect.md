...
### Реализации post_detail, post_update и post_delete 
Модно честно скопировать из прошлых лекций (четверг). 
***Небольшая просьба*** , после того, как скопируете update и delete - создайте около 15 постов, т.к. завтра
будем прикручивать пагинацию.